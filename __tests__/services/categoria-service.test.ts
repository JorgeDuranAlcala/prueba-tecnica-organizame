...
describe("Categoria service", () => {
  ...
  describe("Categorias CRUD", () => {
    ...
    test("find a categoria by its ID", async () => {
      ...
      expect(_fakeCategoriaRepository.findById).toHaveBeenCalledWith(
        categoria_id
      );
    });
    ...
    test("Remove a categoria by its ID", async () => {
      ...
      expect(_fakeCategoriaRepository.remove).toHaveBeenCalledWith(
        categoria_id
      );
    });
    ...
    test("update a categoria", async () => {
      ...
      expect(cate).toBeDefined();
      expect(cate.nombre_categoria.length).toEqual(
        dataUpdateDto.nombre_categoria.length
      );
